...
ImputeGAN~\citep{qin2023imputegan} couples a GAN with an iterative
gradient-based refinement step, reporting smaller distributional drift
than case deletion, statistics-based and machine-learning
baselines~\citep{vanbuuren1999multiple}. A complementary line of work
...
panels~\citep{wang2025attn}. Beyond price reconstruction, missing-data scenarios in
