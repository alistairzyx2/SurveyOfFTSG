...
\subsubsection{Applications of FTSE}
...
\subsubsection{Applications of FTSI}
...
agent. GAIN~\citep{yoon2018gain} introduced the generative-adversarial
...
\subsubsection{Applications of FTSS}
...
\paragraph{Strategy backtesting and replay.}
...
\citet{balch2019how} compare single-agent market replay against
...
strategy rankings. \citet{rollins2020which} extend this with a threaded
...
\paragraph{Stress testing, scenario generation and risk management.}
...
\paragraph{Trading-agent training environments.}
...
\paragraph{Privacy-preserving data sharing and regulatory scenarios.}
Synthetic financial data is a recognized route to overcome the friction
...
the regulatory side, \citet{balch2024six} argue that FTSS pipelines can
...
% --- 5.3.4 Cross-cutting ---------------------------------------------
\subsubsection{Cross-cutting Use: Synthetic Datasets as Benchmarks}
