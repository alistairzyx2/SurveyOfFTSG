...
smaller distributional drift on the K-line dataset than linear interpolation or MICE
 baselines~\citep{vanbuuren1999multiple}. Beyond price reconstruction, missing-data scenarios in
