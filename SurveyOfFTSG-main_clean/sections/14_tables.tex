...
\midrule
\textbf{This survey}      & \checkmark & \checkmark & \checkmark & \textbf{Protocol} & \textbf{Financial TS} & \textbf{199} & \textbf{1950--2026} \\
\bottomrule
\end{tabular}
\end{table*}
