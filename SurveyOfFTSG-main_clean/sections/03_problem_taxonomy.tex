...
Statistical and probabilistic methods include classical approaches such as ARIMA~\citep{box2015time} and GARCH~\citep{bollerslev1986garch}, which model conditional mean and variance based on rigid mathematical assumptions.
...
Controllable and multimodal generative models, including TimeWeaver~\citep{narasimhan2024timeweaver} and T2S~\citep{T2S}, are designed to generate sequences conditioned on textual instructions, macroeconomic indicators, or specific volatility regimes~\citep{wang2024mtsisurvey}.
