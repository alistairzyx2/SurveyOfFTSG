...
%DIF DEL /tmp/redline_HIGRfR/old/flat.tex   Sun Sep 13 21:17:24 2026
%DIF ADD /tmp/redline_HIGRfR/new/flat.tex   Sun Sep 13 21:17:24 2026
...
The first trend concerns unified multi-task architectures: instead of treating imputation as an isolated preprocessing step, modern models increasingly solve related financial tasks simultaneously to improve representational learning. For example, \DIFdelbegin \DIFdel{Miao et al.~}%DIFDELCMD < \citep{miao2025} %%%
\DIFdel{propose }\DIFdelend coupled diffusion models \DIFaddbegin \DIFadd{have been developed }\DIFaddend that jointly perform forecasting and imputation, leveraging shared latent representations to enforce temporal consistency. To enhance structural robustness, \DIFdelbegin \DIFdel{Zhang et al.~}%DIFDELCMD < \citep{zhang2023imputation} %%%
